...
<head>
    ...
    <title>Content Management - MAX1ON1FITNESS</title>
    ...
    <div class="admin-container">
        ...
        <main class="admin-main">
            ...
            <div class="stats-grid">
                <div class="stat-card">
                    <div class="stat-number"><?php echo count($all_content); ?></div>
            ...
            <div class="content-card">
                <form method="GET" action="" class="filter-bar">
                    ...
                    <?php if ($search_term || $selected_page): ?>
                        <a href="content.php" class="btn btn-secondary btn-sm">Clear Filters</a>
                    <?php endif; ?>
                </form>
            </div>
