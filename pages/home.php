...
<head>
    ...
    <title><?php echo SiteContent::getValue($db, 'home.hero.title', 'MAX1ON1FITNESS - Multi-Device Sports & Fitness Solutions'); ?></title>
    ...
    <nav class="navbar">
        <div class="container">
            <div class="nav-wrapper">
                <a href="../index.php" class="logo"><?php echo SiteContent::getValue($db, 'home.header.brand', 'MAX1ON1'); ?><span>FITNESS</span></a>

                <ul class="nav-menu">
                    <li><a href="home.php" class="nav-link active"><?php echo SiteContent::getValue($db, 'home.header.nav.home', 'Home'); ?></a></li>
                ...
                <div class="nav-actions">
                    <?php if ($isLoggedIn): ?>
                        ...
                        <?php if (isAdmin()): ?>
                            <a href="../admin/dashboard.php" class="btn-outline">Admin</a>
                        <?php endif; ?>
                        <a href="logout.php" class="btn-outline">Logout</a>
                    <?php else: ?>
                        <a href="login.php" class="btn-outline"><?php echo SiteContent::getValue($db, 'home.header.login_button', 'Login'); ?></a>
                        <a href="signup.php" class="btn-gradient"><?php echo SiteContent::getValue($db, 'home.header.signup_button', 'Get Started'); ?></a>
                    <?php endif; ?>
                </div>
    ...
    <footer class="footer">
        <div class="container">
            ...
            <div class="footer-bottom">
                <p><?php echo SiteContent::getValue($db, 'home.footer.copyright', '© 2024 MAX1ON1FITNESS. All rights reserved.'); ?></p>
            </div>
        </div>
    </footer>
